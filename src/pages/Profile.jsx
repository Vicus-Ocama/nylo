  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        <div className="flex items-start gap-6 mb-10 pb-10 border-b border-gray-100">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-500">
              <span><strong className="text-gray-900">{articles.length}</strong> articles</span>
              <span><strong className="text-gray-900">{totalViews}</strong> total views</span>
        ...
        {/* Articles */}
        <h2 className="text-base font-semibold text-gray-800 mb-6">Published articles</h2>
        {articles.length === 0 ? (
          <p className="text-gray-400 text-sm">This writer hasn't published anything yet.</p>
        ) : (
